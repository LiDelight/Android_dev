...
public class Comment1Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comment1_list);

        mlistview = (ListView) findViewById(R.id.ListViewComment);
        ...
        this.mlistview.setOnItemClickListener(new OnItemClickListener(){
                                    ...
                                    long arg3) //被选中子项的行号
            {
                ...
                final commentdialog orderDlg = new commentdialog(Comment1Activity.this);
