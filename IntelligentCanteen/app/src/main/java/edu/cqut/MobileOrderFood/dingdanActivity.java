...
public class dingdanActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mtvTotalPrice = (TextView)findViewById(R.id.ordertotalprice);
        ...
        Button button1=(Button)findViewById(R.id.submit_ok);
        Button button2=(Button)findViewById(R.id.btnCancel);
        button1.setOnClickListener(new View.OnClickListener()
        {
            public void onClick (View v)
            {
                Toast.makeText(dingdanActivity.this, "用户名或者密码错误", Toast.LENGTH_LONG).show();
                Date date=new Date();
                Order order=new Order(appInstance.g_cart);
                //appInstance.g_orders.morders.add(order);
            }
        });
        ...
        this.mlistview.setOnItemClickListener(new OnItemClickListener(){
                                    ...
                                    long arg3) //被选中子项的行号
            {
                ...
                //创建购买数量对话框
                final OrderOneDialog orderDlg = new OrderOneDialog(dingdanActivity.this);
                ...
                orderDlg.setOnDismissListener(new DialogInterface.OnDismissListener() {
                    ...
                    public void onDismiss(DialogInterface dialog) {
                        if (orderDlg.mBtnClicked == OrderOneDialog.ButtonID.BUTTON_OK) {
                            ...
                            Toast.makeText(dingdanActivity.this, tvTitle.getText().toString()+":"
